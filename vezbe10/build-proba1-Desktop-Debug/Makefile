...
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile ../proba1/proba1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../proba1 -I. -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I. -I. -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = proba11.0.0
DISTDIR = /home/raspberry/Desktop/vezbe/vezbe10/build-proba1-Desktop-Debug/.tmp/proba11.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = ../proba1/main.cpp \
		../proba1/dialog.cpp moc_dialog.cpp
OBJECTS       = main.o \
		dialog.o \
		moc_dialog.o
DIST          = /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		...
		../proba1/proba1.pro ../proba1/dialog.h ../proba1/main.cpp \
		../proba1/dialog.cpp
QMAKE_TARGET  = proba1
DESTDIR       = 
TARGET        = proba1
...
proba1: ui_dialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ../proba1/proba1.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/lex.prf \
		../proba1/proba1.pro
	$(QMAKE) -o Makefile ../proba1/proba1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../proba1/dialog.h $(DISTDIR)/
	$(COPY_FILE) --parents ../proba1/main.cpp ../proba1/dialog.cpp $(DISTDIR)/
	$(COPY_FILE) --parents ../proba1/dialog.ui $(DISTDIR)/
...
moc_dialog.cpp: ../proba1/dialog.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/raspberry/Desktop/vezbe/vezbe10/build-proba1-Desktop-Debug/moc_predefs.h -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/raspberry/Desktop/vezbe/vezbe10/proba1 -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I. -I/usr/include/c++/10 -I/usr/include/arm-linux-gnueabihf/c++/10 -I/usr/include/c++/10/backward -I/usr/lib/gcc/arm-linux-gnueabihf/10/include -I/usr/local/include -I/usr/include/arm-linux-gnueabihf -I/usr/include ../proba1/dialog.h -o moc_dialog.cpp
...
ui_dialog.h: ../proba1/dialog.ui \
		/usr/lib/qt5/bin/uic
	/usr/lib/qt5/bin/uic ../proba1/dialog.ui -o ui_dialog.h
...
main.o: ../proba1/main.cpp ../proba1/dialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../proba1/main.cpp

dialog.o: ../proba1/dialog.cpp ../proba1/dialog.h \
		ui_dialog.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dialog.o ../proba1/dialog.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/proba1/bin || mkdir -p $(INSTALL_ROOT)/opt/proba1/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/proba1/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/proba1/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/proba1/bin/ 
